        ...
        <main>
          <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item active">Data Mata Pelajaran Smandagiri</li>
              <br />
            </ol>
            <div class="row">
              <div class="col-xl-6">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form method="POST" action="inputMapel.php">
                          <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Nama Mata Pelajaran</label>
                            <input type="text" class="form-control" id="recipient-name" placeholder="ex: Fisika" name="mapel" />
                          </div>
                          <div class="mb-3">
                            <label for="message-text" class="col-form-label">Guru Pengampu</label>
                            <textarea class="form-control" id="message-text" placeholder="ex:Sigit Wahono, S.Pd" name="guru"></textarea>
                          </div>
              ...
              <table class="table">
                ...
                <?php
                    ...
                    $mapelDecrypt = openssl_decrypt($newMapel, $ALGORITHM, $password, 0, $IV);
                    $guruDecrypt = openssl_decrypt($newGuru, $ALGORITHM, $password, 0, $IV);

                ?>
    
                <tr>
                    <td><?php echo $mapelDecrypt;?></td>
                    <td><?php echo $guruDecrypt;?></td>
