...
<html lang="en">
  <head>
    ...
    <title>Nilai Siswa Smandagiri</title>
          ...
          <div class="container-fluid px-4">
            ...
            <table class="table">
                ...
                <?php
                    ...
                    $nilaiDecrypt = openssl_decrypt($newNilai, $ALGORITHM, $password, 0, $IV);
                ?>
    
                <tr>
                    <td><?php echo $newNama;?></td>
                    <td><?php echo $newMapel;?></td>
                    <td><?php echo $nilaiDecrypt;?></td>
